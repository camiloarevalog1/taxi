...
<div class="card-header d-flex align-items-center">
                      <h3 class="h4">Actualizar Conductor</h3>
                    </div>
                    <div class="card-body">
                      <form class="form-horizontal" action="{{ url('/edit',[$conductor->id]) }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Nombres</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="nombre" value="{{ $conductor->nombres}}" required>
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="apellido"  value="{{ $conductor->apellidos}}" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="telefono" value="{{ $conductor->telefono}}" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="email" value="{{ $conductor->email}}" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="password" name="password" class="form-control" value="{{ $conductor->password}}" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="username" value="{{ $conductor->username}}"  required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="number" class="form-control" name="rut" value="{{ $conductor->RUT}}" required>
                          </div>
                        </div>
